...
def bisection_method(f, a, b, TOL=0.0001, verbose=True):
    ...
    print(bcolors.OKCYAN, "With the error estimation formula we got the minimum number of iterations required to reach the desired accuracy is", minSteps, bcolors.ENDC)
    if verbose:
        print("{:<10} {:<15} {:<15} {:<15} {:<15} {:<15} {:<15}".format("Iteration", "a", "b", "f(a)", "f(b)", "c", "f(c)"))

    while abs(b - a) > TOL and k < minSteps:
...
#Printing section for debugging purposes
#print("-----------------")
#print("Polynomial", polynomial)
#print("derivative: ",derivative)
#print(f)
